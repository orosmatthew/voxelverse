...
public:
    ...
    void cleanup(const vk::DispatchLoaderDynamic& loader, const vk::Device device)
    {
    ...
    void free(const vk::DispatchLoaderDynamic& loader, const vk::Device device, const DescriptorSetImpl& descriptor_set)
    {
...
private:
    ...
    [[nodiscard]] vk::DescriptorPool create_pool(
        const vk::DispatchLoaderDynamic& loader,
        const vk::Device device,
        const vk::DescriptorPoolCreateFlags flags = vk::DescriptorPoolCreateFlags()) const
    {
