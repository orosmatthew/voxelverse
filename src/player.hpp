...
public:
    ...
    [[nodiscard]] mve::Vector3 position() const
    {
    ...
    [[nodiscard]] mve::Vector3 direction() const
    {
        const mve::Matrix4 transform = m_head_transform * m_body_transform;
    ...
    [[nodiscard]] mve::Vector3 target() const
    {
        return position() + direction();
    }

    [[nodiscard]] static mve::Vector3 up()
    {
        return { 0, 0, 1 };
    }
    ...
    [[nodiscard]] mve::Vector3 velocity() const
    {
        return m_velocity;
    }
