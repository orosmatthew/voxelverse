...
PauseMenu::PauseMenu(UIPipeline& ui_pipeline, TextPipeline& text_pipeline)
    : m_button_texture(std::make_shared<mve::Texture>(ui_pipeline.renderer(), "../res/button_gray.png"))
    , m_button_texture_hover(std::make_shared<mve::Texture>(ui_pipeline.renderer(), "../res/button_gray_hover.png"))
    , m_button_texture_pressed(std::make_shared<mve::Texture>(ui_pipeline.renderer(), "../res/button_gray_pressed.png"))
